...
export default function StaffDashboard({ currentUser, sendToGoogleSheet }) {
  ...
  // লগইন করা স্টাফের বরাদ্দকৃত বাস ও রেট ডেটাবেজ থেকে ফেচ করা
  useEffect(() => {
    const fetchStaffData = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          const dataBuses = docSnap.data().buses || [];
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', fontFamily: fontStyle, maxWidth: '700px', margin: '0 auto', padding: '10px', color: '#F8FAFC' }}>
      ...
      <style>{`
        ...
        * {
        ...
        /* ৩ডি নেভিগেশন বার সিএসএস (মোবাইল রেসপন্সিভ) */
        .staff-nav-container {
          position: relative;
          display: flex;
          align-items: center;
        ...
        .staff-indicator {
          ...
          transition: left 0.35s cubic-bezier(0.34, 1.28, 0.74, 1);
          z-index: 1;
        }
      ...
      <div className="staff-nav-container">
        <div 
          className="staff-indicator" 
          style={{ left: activeTab === 0 ? '4px' : 'calc(50%)' }}
        ></div>

        <div 
          className={`staff-nav-item ${activeTab === 0 ? 'active' : ''}`}
        ...
        <div 
          className={`staff-nav-item ${activeTab === 1 ? 'active' : ''}`}
        ...
        <div className="tab-content" style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '20px' }}>
            <h3 style={{ margin: '0 0 6px', fontSize: '18px', fontWeight: '700', color: '#F8FAFC' }}>
              🚌 স্টাফ ড্যাশবোর্ড (টিকেট ও কমিশন এন্ট্রি)
            </h3>
            <p style={{ margin: 0, fontSize: '13px', color: '#94A3B8', fontWeight: '500' }}>
              আপনার বরাদ্দকৃত কাউন্টার/বাস এবং কমিশন রেট দিয়ে তথ্য জমা দিন।
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div>
              ...
              <input 
                ...
                style={{ 
                  width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid #1D3557', 
                  background: '#0A1422', color: '#F8FAFC', fontSize: '14px', outline: 'none', boxSizing: 'border-box'
                }} 
                required 
              />
            </div>
            ...
            <div>
              ...
              <select 
                ...
                style={{ 
                  width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid #1D3557', 
                  background: '#0A1422', color: '#F8FAFC', fontSize: '14px', outline: 'none', boxSizing: 'border-box', cursor: 'pointer'
                }} 
                required
              >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              <div>
                ...
                <input 
                  ...
                  style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid #1D3557', background: '#0A1422', color: '#F8FAFC', fontSize: '14px', outline: 'none', boxSizing: 'border-box' }} 
                  required 
                />
              </div>
              <div>
            ...
            <button 
              ...
              style={{ 
                ...
                background: isSubmitting ? '#4B5563' : 'linear-gradient(135deg, #2563EB 0%, #7C3AED 100%)', 
                color: '#fff', border: 'none', borderRadius: '10px', fontWeight: '600', 
                cursor: isSubmitting ? 'not-allowed' : 'pointer', fontSize: '15px', 
      ...
      {activeTab === 1 && (
        <div className="tab-content" style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '20px' }}>
            ...
            <p style={{ margin: 0, fontSize: '13px', color: '#94A3B8', fontWeight: '500' }}>
              আপনার ব্রাঞ্চের দৈনন্দিন খরচসমূহ এন্ট্রি দিন।
            </p>
          </div>
          ...
          <form onSubmit={handleExpenseSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <button 
              ...
              style={{ 
                width: '100%', padding: '13px', 
                background: isExpenseSubmitting ? '#4B5563' : 'linear-gradient(135deg, #2563EB 0%, #7C3AED 100%)', 
                color: '#fff', border: 'none', borderRadius: '10px', fontWeight: '600', 
                cursor: isExpenseSubmitting ? 'not-allowed' : 'pointer', fontSize: '15px', 
                boxShadow: '0 4px 14px rgba(37, 99, 235, 0.35)', transition: 'all 0.2s',
                opacity: isExpenseSubmitting ? 0.7 : 1
              }}
            >
